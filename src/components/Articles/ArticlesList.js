                ...
                return (
                    <div key={article.id} className="article-list-item mb-12 flex">
                        <div className="article-list-content flex-1">
                            <h1>
                                <Link href={getArticleURL(article)} title={article.title} className="font-medium text-xl block hover:text-primary ">
                                    {article.title}
                                </Link>
                            </h1>
                            <div className="text-slate-500 text-base py-3 leading-6">{article.description}</div>
                        ...
                        <div className="ml-4">
                            <Link href={getArticleURL(article)} title={article.title}>
                                <Image src={article.img_url} width={124} height={124} className="rounded-sm" alt={article.title} />
                            </Link>
                        </div>
                    </div>
                )
